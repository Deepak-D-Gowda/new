...
# # Reading an image
img = cv2.imread(r'D:\code\datasets\test\cloth\1212.jpg')
...
hsv = cv2.cvtColor(cv2.imread(r'D:\code\datasets\test\cloth\1212.jpg'), cv2.COLOR_BGR2HSV)
print(hsv.shape)
...
cv2.imwrite(r'D:\code\datasets\test\cloth-mask\1212.jpg',Mask)
...
# import cv2
# test_image = cv2.imread(r'D:\code\datasets\test\image-parse\1.png')
# test_image3 = test_image.reshape((-1, 3))[:, :2]
# test_image2 = cv2.imread(r'D:\code\datasets\test\image-parse\00891_00.png')
...
img = Image.open(r'D:\code\datasets\test\image\0002190.jpg')
print(img)
img = img.convert('P')
print(img)
img = img.convert('RGB')
img= img.save(r"D:\code\datasets\test\image\0002190.jpg")
