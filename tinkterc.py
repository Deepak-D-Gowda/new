    ...
    with torch.no_grad():
        for i, inputs in enumerate(test_loader.data_loader):  
            ...
            for img_name, c_name in zip(img_names, c_names):
                ...
                im1 = os.path.join('D:/code/datasets/test/image',img_name).replace('\\','/')
                im2 = os.path.join('D:/code/datasets/test/cloth',c_name).replace('\\','/')
                im5 = os.path.join('D:/code/datasets/test/image-parse',f'{image_parse}.png').replace('\\','/')
                print(im5)
                im6 = os.path.join('D:/code/datasets/test/openpose-img',f'{image_parse}_rendered.png').replace('\\','/')
                print(im6)
            ...
            filen = im4.split('/')[-1]
            fpath = f'D:/code/results/new/{filen}'

            nfile = im3.split('/')[-1]
            newf = f'D:/code/results/new/{nfile}'
